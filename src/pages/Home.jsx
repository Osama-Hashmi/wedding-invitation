  ...
  return (
    <main className={`home-page ${opened ? "opened" : ""}`}>
      ...
      <audio ref={audioRef} loop preload="auto">
        <source src="/music/Mile%20Ho%20Tum%20Humko.mp3" type="audio/mpeg" />
      </audio>
      ...
      <div className={`envelope-screen ${opened ? "is-opened" : ""}`}>
        <div className="envelope-stage">
          ...
          <div className="envelope-invitation-title">Invitation</div>
          ...
          <div className="opening-card">
            ...
            <div className="opening-card-inner">
              <span className="opening-kicker">YOU ARE CORDIALLY INVITED</span>

              <h1>Wedding</h1>

              <div className="opening-line"></div>

              <span className="opening-of">OF</span>

              <h2>
                Osama <span>♡</span> Areeba
              </h2>

              <p>TWO HEARTS · TWO FAMILIES</p>

              <small>ONE BEAUTIFUL BEGINNING</small>
            </div>
          </div>
          ...
          <div className="envelope">
            ...
            <div className="envelope-flower envelope-flower-tl">❦</div>

            <div className="envelope-flower envelope-flower-tr">❦</div>

            <div className="envelope-flower envelope-flower-bl">❦</div>

            <div className="envelope-flower envelope-flower-br">❦</div>

            {/* ================= FLAP ================= */}

            <div className="envelope-flap">
              <div className="flap-floral">❦</div>
            </div>
      ...
      <section className="invitation-content">
        <div className="invitation-inner">
          ...
          <div className="quran-verse">وَخَلَقْنَاكُمْ أَزْوَاجًا</div>

          <p className="verse-translation">“And We created you in pairs.”</p>

          <p className="verse-reference">An-Naba | Verse 8</p>
          ...
          <p className="celebration-label">OUR CELEBRATIONS</p>

          <section className="ceremonies">
            {/* ================= MEHNDI 1 ================= */}

            <Link to="/mehndi-invite-2741" className="ceremony-box mehndi-box">
              <div className="card-floral top-left">❀</div>

              <div className="card-floral top-right">❦</div>

              <div className="card-floral bottom-left">❦</div>

              <div className="card-floral bottom-right">❀</div>
            ...
            >
              ...
              <div className="ceremony-content">
                ...
                <p>An Evening of Love & Tradition</p>
            ...
            <Link to="/valima-invite-7365" className="ceremony-box valima-box">
              <div className="card-floral top-left">❀</div>
              ...
              <div className="ceremony-content">
                <span className="ceremony-label">THE RECEPTION</span>

                <h2>Valima</h2>

                <p>An Evening of Love & Celebration</p>
          ...
          <section className="family-section">
            ...
            <p className="family-heading">WITH LOVE & BLESSINGS</p>
